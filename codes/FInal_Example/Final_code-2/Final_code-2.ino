...
void Take_Readings()
{
   ...
   if (checkForBeat(irValue) == true)
  {
   ...
   if(digitalRead(STRIP_DETECT) == LOW)
   {
    ...
    blood_strip_Voltage = Analog_Value * 0.00322265625; // step size 3.3v/1024
   }
...
void writeThingSpeak(void)
{
  ...
  getStr += API;
  getStr +="&field1=";
  getStr += String(Pulse_Sensor_op);
  getStr +="&field2=";
  getStr += String(Oxygen_Saturation_Level);
  getStr +="&field3=";
  getStr += String(Body_Temprature_Level);
  getStr +="&field4=";
  getStr += String(blood_strip_Voltage);
  getStr += "\r\n\r\n";
